...
from torchtune.models.llama3._component_builders import llama3, lora_llama3, lora_tinyllama3_149b
...
Llama3 8B model.
"""
def tinyllama3_149b() -> TransformerDecoder:
    """
    Builder for creating a Llama3 model initialized w/ the default 1.49b parameter values.

    Returns:
        TransformerDecoder: Instantiation of  TinyLlama3 1.49B model
    """
    return llama3(
        vocab_size=128_256,
        num_layers=32,
...
def lora_tinyllama3_149b(
    ...
    """
    Builder for creating a TinyLlama3 1.49B model with LoRA enabled.

    The Llama3 defaults are the same as in :func:`~torchtune.models.llama3.tinyllama3_149b`,
    ...
    Returns:
        TransformerDecoder: Instantiation of TinyLlama3 1.49B model with LoRA applied
    """
    return lora_tinyllama3_149b(
